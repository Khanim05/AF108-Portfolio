...
document.addEventListener("DOMContentLoaded", ()=>{
  ...
  function createUserCard() {
     products.forEach(product => {
        ...
        cardHeart.addEventListener("click", ()=>{
            toggleuserwishlist(product.id,cardHeart)
        })
        ...
        cardContent.append(cardTittle,cardCategory,cardFooter)
  ...
  function toggleuserwishlist(productId,cardHeart) {
    // console.log(productId)
    if(!loginedUser){
    toast("Add elemek ucun login ol")
    setTimeout(() => {
    ...
    if (loginedUserProduct) {
        ...
        localStorage.setItem("users",JSON.stringify(users))
        toast("Mehsul sevimlilere elave olundu")
